...
void compileConstant(void) {
  ...
  //   eat(SB_PLUS);
  //   compileConstant2();   // Chia nho cac fuction ra cho de quan sat, code ro rang hon. Vi the nen co compileConstant2()
  // }
...
// void compile_newCondition(void){    // Con thieu truong hop == va <>
//   if(lookAhead->tokenType == TK_IDENT){
//     eat(TK_IDENT);
//   }
//   eat(SB_ASSIGN);
...
//   eat(sb_DAUHOICHAM); // tim "?" va them vao
//   compileExpression();
//   eat(SB_COLON);
//   compileExpression();
// }
